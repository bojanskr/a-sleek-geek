...
// Task: Copy Files
function copyFiles() {
    const assetsFolder = gulp.src(['./assets/**/*', '!./assets/js/main.js'])
      .pipe(gulp.dest(distDir))
      .pipe(browserSync.stream());
  
    const formsFolder = gulp.src('/forms/**/*')
...
// Watch files
function watchFiles() {
  gulp.watch("/assets/scss/**/*", compileSCSS);
  gulp.watch("/assets/html/**/*.html", compileHTML);
  gulp.watch(["/assets/**/*", "/assets/js/main.js"], copyFiles);
  gulp.watch("/assets/js/main.js", compileJS);
}
